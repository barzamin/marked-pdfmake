/**
 * marked-pdf/PdfParser.js
 *
 * Parser functions extracted from marked.js.
 * Not really modified except for using the PdfRenderer.
 */
"use strict";

const marked = require('marked');
const PdfRenderer = require('./pdfRenderer');
const { defaultDocDefinition } = require('./defaults');
